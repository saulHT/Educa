...
let aAudio = new Audio('/sounds/Leccion4/Ej1/Leccion4Ej1P1.wav');
let eAudio = new Audio('/sounds/Leccion4/Ej1/Leccion4Ej1P2.wav');
let iAudio = new Audio('/sounds/Leccion4/Ej1/Leccion4Ej1P3.wav');
let oAudio = new Audio('/sounds/Leccion4/Ej1/Leccion4Ej1P4.wav');
let uAudio = new Audio('/sounds/Leccion4/Ej1/Leccion4Ej1P5.wav');
...
function showResult(){
    ...
    link = `/paginas/Leccion4Ej2?puntos=${userScore}`;
    winAudio.play();
