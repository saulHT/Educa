...
let aAudio = new Audio('/sounds/Subtema2/Exam1/1.wav');
let eAudio = new Audio('/sounds/Subtema2/Exam1/2.wav');
let iAudio = new Audio('/sounds/Subtema2/Exam1/3.wav');
let oAudio = new Audio('/sounds/Subtema2/Exam1/4.wav');
let uAudio = new Audio('/sounds/Subtema2/Exam1/5.wav');
let a2Audio = new Audio('/sounds/Subtema2/Exam1/6.wav');
let e2Audio = new Audio('/sounds/Subtema2/Exam1/7.wav');
let i2Audio = new Audio('/sounds/Subtema2/Exam1/8.wav');
let o2Audio = new Audio('/sounds/Subtema2/Exam1/9.wav');
let u2Audio = new Audio('/sounds/Subtema2/Exam1/10.wav');
...
function showQuetions(index){
    ...
    let que_tag = '<span>'+ '<img src="/Images/Leccion/Subtema2/Exam1/'+questions[index].numb+'.png" width="490" height="250" alt="">'+'</span>';
...
function showResult(){
    ...
    link = `/paginas/Subtema2E1Finish?puntos=${userScore}`;
    winAudio.play();
