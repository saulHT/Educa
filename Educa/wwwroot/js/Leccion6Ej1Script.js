...
let aAudio = new Audio('/sounds/Leccion6/Ej1/1.wav');
let eAudio = new Audio('/sounds/Leccion6/Ej1/2.wav');
let iAudio = new Audio('/sounds/Leccion6/Ej1/3.wav');
let oAudio = new Audio('/sounds/Leccion6/Ej1/4.wav');
let uAudio = new Audio('/sounds/Leccion6/Ej1/5.wav');
let startAudio = new Audio('/sounds/Leccion6/Ej1/Leccion6Ej1Intro.wav');
...
function showResult(){
    ...
    link = `/paginas/Leccion6Finish?puntos=${userScore}`;
    winAudio.play();
